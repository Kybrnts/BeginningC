/* Protram 2.17 Working with complex numbers */
/* This is a simple example that creates a couple of complex variables  and prerforms simple arithmetic operations */
#include <complex.h>
#include <stdio.h>
...
int main(void) {
  ...
  printf("\nStarting values: cx = %.2f+%.2fi cy = %.2f+%2.fi",
